const texts = {
  en: {
    ...
    options: {
      ...
      instrumentSaxTenor: "Tenor Sax",
      instrumentSaxAlt: "Alto Sax",
      instrumentGuitar: "Guitar",
      instrumentRegular: "Piano",
    ...
    tooltips: {
      ...
      instrumentSaxTenor: "The tenor saxophone is notated a major ninth (14 semitones) higher than it sounds and is therefore tuned in B♭.",
      instrumentSaxAlt: "The alto saxophone is notated a major sixth (9 semitones) higher than it sounds and is therefore tuned in E♭.",
      instrumentGuitar: "The guitar is notated an octave lower than it sounds.",
      instrumentRegular: "Most instruments are notated as they sound.",
  ...
  de: {
    ...
    options: {  
      ...
      instrumentSaxTenor: "Tenor Sax",
      instrumentSaxAlt: "Alt Sax",
      instrumentGuitar: "Gitarre",
      instrumentRegular: "Klavier",
    ...
    tooltips: {
      ...
      instrumentSaxTenor: "Das Tenorsaxophon notiert eine große None (14 Halbtöne) höher als klingend und ist damit in B gestimmt.",
      instrumentSaxAlt: "Das Altsaxophon notiert eine große Sexte (9 Halbtöne) höher als klingend und ist damit in Es gestimmt.",
      instrumentGuitar: "Die Gitarre notiert eine Oktave tiefer als klingend.",
      instrumentRegular: "Die meisten Instrumente notieren wie klingend.",
  ...
  it: {
    ...
    options: {
      ...
      instrumentSaxTenor: "Sax Tenore",
      instrumentSaxAlt: "Sax Alto",
      instrumentGuitar: "Chitarra",
      instrumentRegular: "Pianoforte",
    ...
    tooltips: {
      ...
      instrumentSaxTenor: "Il sassofono tenore è notato una nona maggiore (14 semitoni) più alta di come suona ed è quindi accordato in Si♭.",
      instrumentSaxAlt: "Il sassofono alto è notato una sesta maggiore (9 semitoni) più alta di come suona ed è quindi accordato in Mi♭.",
      instrumentGuitar: "La chitarra è notata un'ottava più bassa di come suona.",
      instrumentRegular: "La maggior parte degli strumenti è notata come suona.",
  ...
  fr: {
    ...
    tooltips: {
      ...
      instrumentSaxTenor: "Le saxophone ténor est noté une neuvième majeure (14 demi-tons) plus haut qu'il ne sonne et est donc accordé en Si♭.",
      instrumentSaxAlt: "Le saxophone alto est noté une sixte majeure (9 demi-tons) plus haut qu'il ne sonne et est donc accordé en Mi♭.",
      instrumentGuitar: "La guitare est notée une octave plus basse qu'elle ne sonne.",
      instrumentRegular: "La plupart des instruments sont notés comme ils sonnent.",
  ...
  es: {
    ...
    options: {
      ...
      instrumentSaxTenor: "Sax Tenor",
      instrumentSaxAlt: "Saxo Alto",
    ...
    tooltips: {
      ...
      instrumentSaxTenor: "El saxofón tenor se nota una novena mayor (14 semitonos) más alta de lo que suena y, por lo tanto, está afinado en Si♭.",
      instrumentSaxAlt: "El saxofón alto se nota una sexta mayor (9 semitonos) más alta de lo que suena y, por lo tanto, está afinado en Mi♭.",
      instrumentGuitar: "La guitarra se nota una octava más baja de lo que suena.",
      instrumentRegular: "La mayoría de los instrumentos se notan como suenan.",
  ...
  pt: {
    ...
    tooltips: {
      ...
      instrumentSaxTenor: "O saxofone tenor é notado uma nona maior (14 semitons) mais alta do que soa e, portanto, está afinado em Si♭.",
      instrumentSaxAlt: "O saxofone alto é notado uma sexta maior (9 semitons) mais alta do que soa e, portanto, está afinado em Mi♭.",
      instrumentGuitar: "O violão é notado uma oitava mais baixa do que soa.",
      instrumentRegular: "A maioria dos instrumentos é notada como soa.",
  ...
  nl: {
    ...
    options: {
      ...
      offsetInput: "Offset (Hz)",
      instrumentSaxTenor: "Tenorsaxofoon",
      instrumentSaxAlt: "Altsaxofoon",
      instrumentGuitar: "Gitaar",
      instrumentRegular: "Piano",
      smallRangeRadio: "Klein",
    ...
    tooltips: {
      ...
      instrumentSaxTenor: "De tenorsaxofoon wordt een grote none (14 halve tonen) hoger genoteerd dan hij klinkt en is daarom gestemd in Bes.",
      instrumentSaxAlt: "De altsaxofoon wordt een grote sext (9 halve tonen) hoger genoteerd dan hij klinkt en is daarom gestemd in Es.",
      instrumentGuitar: "De gitaar wordt een octaaf lager genoteerd dan hij klinkt.",
      instrumentRegular: "De meeste instrumenten worden genoteerd zoals ze klinken.",
  ...
  pl: {
    ...
    options: {
      ...
      instrumentSaxTenor: "Saksofon tenorowy",
      instrumentSaxAlt: "Saksofon altowy",
      instrumentGuitar: "Gitara",
      instrumentRegular: "Fortepian",
    ...
    tooltips: {
      ...
      instrumentSaxTenor: "Saksofon tenorowy jest notowany o dużą nonę (14 półtonów) wyżej niż brzmi i jest strojony w B♭.",
      instrumentSaxAlt: "Saksofon altowy jest notowany o dużą sekstę (9 półtonów) wyżej niż brzmi i jest strojony w E♭.",
      instrumentGuitar: "Gitara jest notowana o oktawę niżej niż brzmi.",
      instrumentRegular: "Większość instrumentów jest notowana tak, jak brzmi.",
  ...
  hu: {
    ...
    options: {
      ...
      instrumentSaxTenor: "Tenor szaxofon",
      instrumentSaxAlt: "Alt szaxofon",
      instrumentGuitar: "Gitár",
      instrumentRegular: "Zongora",
    ...
    tooltips: {
      ...
      instrumentSaxTenor: "A tenor szaxofon egy nagy nonával (14 félhanggal) magasabban van notálva, mint ahogy szól, ezért B♭-ban van hangolva.",
      instrumentSaxAlt: "Az alt szaxofon egy nagy szexttel (9 félhanggal) magasabban van notálva, mint ahogy szól, ezért E♭-ban van hangolva.",
      instrumentGuitar: "A gitár egy oktávval alacsonyabban van notálva, mint ahogy szól.",
      instrumentRegular: "A legtöbb hangszer úgy van notálva, ahogy szól.",
